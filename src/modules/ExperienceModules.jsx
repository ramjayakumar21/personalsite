...
export default function ExperienceModules(props) {
    ...
    return (
        <div style={{animationDuration:"0.5s"}} className=" ease-linear hover:cursor-pointer transition-all first:mt-0 hover:outline hover:outline-4 outline-[#9ec3f6]  bg-slate-600
         p-7 mt-4 w-4/5 flex flex-col items-center md:flex-row rounded-md gap-3 justify-center">
            ...
            <div className="ml-5">
                <strong>
                    <h1 className="text-3xl md:text-left text-center">{experience.name}</h1>
                </strong>
